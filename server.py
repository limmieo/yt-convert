...
def process(brand):
    ...
    ffmpeg_cmd = [
        ...
        "-i", watermark_path,
        "-filter_complex",
        f"[0:v]scale=1080:1920,format=rgba,setsar=1[v];"
        f"[1:v]format=rgba,colorchannelmixer=aa=0.3[wm];"
        f"[v][wm]overlay=W=main_w-overlay_w-30:H=main_h-overlay_h-30,drawtext="
