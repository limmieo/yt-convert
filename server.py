...
def process_video(brand):
    ...
    try:
        ...
        # random watermark scales & opacities
        ...
        fc = (
            # split watermark into three styles
            ...
            "[b2][top]overlay=x=mod(t*"+str(speed)+",main_w+w)-w:y=60[b3];"

            # finally draw caption box+text
            "[b3]drawtext="
